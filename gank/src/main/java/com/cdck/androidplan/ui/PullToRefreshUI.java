 ...
 */
public class PullToRefreshUI extends LinearLayout implements View.OnTouchListener {
    //下拉状态
     ...
     * @param attrs
     */
    public PullToRefreshUI(Context context, AttributeSet attrs) {
        super(context, attrs);
...
//        setLVIsAbleToPull(event);
        setRVIsAbleToPull(event);
        if (ableToPull) {
     ...
     * @param event
     */
    private void setLVIsAbleToPull(MotionEvent event) {
    ...
    private void setRVIsAbleToPull(MotionEvent event) {
